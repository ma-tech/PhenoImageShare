...
Processor.prototype.loadJSON = function(){
	...
	console.log("Ajax URL: "+query_base_url+"getImages?q="+searchString +":"+getParams);
...
Processor.prototype.loadFacets = function(data){
   ...
   for (var i = 0; i < numDocs; i++) {
	   ...
	   image_url = data.response.docs[i].image_url;
	   image_query_string = this.searchString;
	   
	   detail_url = detail_base_url + "?q="+this.searchString+"&img="+image_url;
